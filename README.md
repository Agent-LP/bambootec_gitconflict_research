...
- Verifica siempre que los nombres de las imágenes coincidan en todos los lugares donde se referencian:
   * En los json de los visuales de imagenes en la carpeta [visuals](https://github.com/Agent-LP/bambootec_gitconflict_research/tree/fix/imageSobreposition/bambootec_gitconflict_research.Report/definition/pages/c9aa5df950a2d49925a9/visuals)
